...
public class Soru2 extends javax.swing.JFrame {
    ...
    public Soru2() {
        ...
        Doktor d2 = new Doktor("Kemal", "Akar");
        Doktor d3 = new Doktor("Kemal", "Beyaz");
        jComboBox1.addItem(d1);
        jComboBox1.addItem(d2);
        jComboBox1.addItem(d3);
    }
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        String doktorAd = ((Doktor)jComboBox1.getSelectedItem()).toString();
        Hasta h = new Hasta(id, ad, soyad);
