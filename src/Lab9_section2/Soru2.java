...
public class Soru2 extends javax.swing.JFrame {
    ...
    private void jButtonEkleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEkleActionPerformed
        ...
        try {
            ...
            String ortalama = jTextFieldOrt.getText();
            // String eklenecek = ad + "," + soyad + "," + ortalama;
            String eklenecek = "\n%s,%s,%s".formatted(ad, soyad, ortalama); // \n ile yeni satır eklemek her işletim sistemi için uygun çözüm değildir
            File f = new File("C:\\Users\\eislamoglu\\Documents\\NetBeansProjects\\BP2\\files\\test.txt");
            writer = new PrintWriter(new FileWriter(f, true));
            writer.write(eklenecek);
        } catch (IOException ex) {
            Logger.getLogger(Soru2.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            writer.close();
